...
public class Keys {
    ...
    public static final ForeignKey<OutbreaksRecord, UsersRecord> OUTBREAKS_IBFK_1 = Internal.createForeignKey(Outbreaks.OUTBREAKS, DSL.name("outbreaks_ibfk_1"), new TableField[] { Outbreaks.OUTBREAKS.USER_ID }, Keys.KEY_USERS_PRIMARY, new TableField[] { Users.USERS.USER_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
    public static final ForeignKey<OutbreaksRecord, VarietiesRecord> OUTBREAKS_IBFK_2 = Internal.createForeignKey(Outbreaks.OUTBREAKS, DSL.name("outbreaks_ibfk_2"), new TableField[] { Outbreaks.OUTBREAKS.VARIETY_ID }, Keys.KEY_VARIETIES_PRIMARY, new TableField[] { Varieties.VARIETIES.VARIETY_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
    ...
    public static final ForeignKey<OutbreaksRecord, SeveritiesRecord> OUTBREAKS_IBFK_4 = Internal.createForeignKey(Outbreaks.OUTBREAKS, DSL.name("outbreaks_ibfk_4"), new TableField[] { Outbreaks.OUTBREAKS.SEVERITY_ID }, Keys.KEY_SEVERITIES_PRIMARY, new TableField[] { Severities.SEVERITIES.SEVERITY_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
