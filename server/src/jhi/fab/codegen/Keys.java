...
public class Keys {
    ...
    public static final ForeignKey<SubsamplesRecord, SsrGenotypesRecord> GENOTYPES = Internal.createForeignKey(Subsamples.SUBSAMPLES, DSL.name("genotypes"), new TableField[] { Subsamples.SUBSAMPLES.GENOTYPE_ID }, Keys.KEY_SSR_GENOTYPES_PRIMARY, new TableField[] { SsrGenotypes.SSR_GENOTYPES.GENOTYPE_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
    public static final ForeignKey<SubsamplesRecord, OutbreaksRecord> OUTBREAKS = Internal.createForeignKey(Subsamples.SUBSAMPLES, DSL.name("outbreaks"), new TableField[] { Subsamples.SUBSAMPLES.OUTBREAK_ID }, Keys.KEY_OUTBREAKS_PRIMARY, new TableField[] { Outbreaks.OUTBREAKS.OUTBREAK_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
    public static final ForeignKey<SubsamplesRecord, VarietiesRecord> VARIETIES = Internal.createForeignKey(Subsamples.SUBSAMPLES, DSL.name("varieties"), new TableField[] { Subsamples.SUBSAMPLES.VARIETY_ID }, Keys.KEY_VARIETIES_PRIMARY, new TableField[] { Varieties.VARIETIES.VARIETY_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
