...
import jhi.fab.codegen.tables.UserSessions.UserSessionsPath;
...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The reference instance of <code>fab.users</code>
     */
    ...
    /**
     * The column <code>fab.users.user_id</code>.
     */
    ...
    /**
     * Create an aliased <code>fab.users</code> table reference
     */
    ...
    /**
     * Create a <code>fab.users</code> table reference
     */
    public Users() {
    ...
    /**
     * Get the implicit to-many join path to the <code>fab.user_sessions</code>
     * table
     */
    public UserSessionsPath userSessions() {
        if (_userSessions == null)
            _userSessions = new UserSessionsPath(this, null, Keys.USER_SESSIONS_IBFK_1.getInverseKey());
