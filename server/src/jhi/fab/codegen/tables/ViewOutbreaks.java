...
public class ViewOutbreaks extends TableImpl<ViewOutbreaksRecord> {
    ...
    /**
     * The column <code>fab.view_outbreaks.nuts_id</code>.
     */
    public final TableField<ViewOutbreaksRecord, Integer> NUTS_ID = createField(DSL.name("nuts_id"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>fab.view_outbreaks.nuts_name</code>.
     */
    public final TableField<ViewOutbreaksRecord, String> NUTS_NAME = createField(DSL.name("nuts_name"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>fab.view_outbreaks.countries_id</code>.
     */
    public final TableField<ViewOutbreaksRecord, Integer> COUNTRIES_ID = createField(DSL.name("countries_id"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>fab.view_outbreaks.countries_name</code>.
     */
    public final TableField<ViewOutbreaksRecord, String> COUNTRIES_NAME = createField(DSL.name("countries_name"), SQLDataType.VARCHAR(255), this, "");
