...
<script lang="ts" setup>
  ...
  const banners = ref<Banner[]>([
    { title: 'View reported outbreaks', img: 'outbreak-list.jpg', color: 'blue-darken-1', icon: 'mdi-table-eye', to: '/outbreak', text: 'View all reported outbreaks and their confirmation status as a list or on a map. Search and filter the results to find what you\'re looking for.' },
    ...
    { title: 'BlightSpy forecast', img: 'blightspy.jpg', color: 'light-green-darken-1', icon: 'mdi-weather-partly-rainy', href: 'https://blightspy.huttonltd.com/', text: 'BlightSpy allows potato growers and agronomists to monitor weather forecasts for the predicted occurrence of Hutton Criteria blight risk.' },
  ])
